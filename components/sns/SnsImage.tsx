    ...
    <div className="mb-[50px]">
      <div className="flex flex-row flex-wrap justify-between">
        {snsImages.map(snsImage => (
          <div key={snsImage.id} className="overflow-hidden border-2 hover:border-[#3b5998] border-white shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)] hover:scale-110 transition duration-300 ease-in-out cursor-pointer">
