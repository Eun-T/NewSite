      ...
      <div className="container">
        ...
        <div className="flex items-center justify-center">
          <div className="w-[38%] text-center">
            <h3 className="text-[#b8b1ca] text-[28px]">타사</h3>
            <ul className="mt-[30px]">
              {arr1.map((arr, index) => (
                <li
                  className="w-full h-[78px] leading-[78px] bg-[#d4ffd4] rounded-[12px] text-center mb-[10px] border-[1px] border-solid border-[#b7ffb7] text-[#b8b1ca] text-[20px]"
                  key={index}
                >
                  {arr}
                </li>
          ...
          <div className="w-[58%] text-center">
            <h3 className="text-[28px] font-[700] textColor">바이럴토스</h3>
            <ul className="mt-[30px]">
              {arr2.map((arr, index) => (
                <li
                  className="w-full h-[78px] leading-[78px] bg-white rounded-[12px] text-center mb-[10px] border-[1px] border-solid border-[#1bbc1b] boxShd text-[20px]"
                  key={index}
                >
                  {arr}
                </li>
        ...
        <h2 className="text-red-500 text-[20px] text-start font-[500] mt-[20px] opacity-60">
