...
const SmartManage = (props: Props) => {
  return (
    <div className="flex flex-col m:flex-row justify-evenly items-center mt-[75px] gap-[30px] m:gap-0">
      <div
      ...
      >
        ...
        <h3 className="max-w-[400px] font-[600] text-[16px] x:text-[17px] m:text-[18px] l:text-[21px] break-keep leading-relaxed text-center mb-[40px]">
      ...
      <div
        className="w-[50px] rotate-[90deg] m:rotate-0 mb-[30px] hidden m:block"
        data-aos="fade-up"
        data-aos-duration="600"
        data-aos-delay="60"
        data-aos-once="true"
      ...
      <div
        className="w-[50px] rotate-[90deg] m:rotate-0 mb-[30px] block m:hidden"
        data-aos="fade-up"
        data-aos-duration="600"
        data-aos-delay="60"
        data-aos-once="true"
        data-aos-easing="ease-in-out"
      >
        <MdOutlineKeyboardDoubleArrowDown className="w-full h-full" />
      </div>
